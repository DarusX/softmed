                    ...
                    <div class="row bg-white has-shadow">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="item d-flex align-items-center">
                                ...
                                <div class="number">
                                    <strong>{{\App\Paciente::all()->count()}}</strong>
                                </div>
                            </div>
                        </div>
                        <!-- Item -->
                            ...
                            <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="project-title d-flex align-items-center">
                                    ...
                                    <div class="text">
                                        ...
                                        <small>{{$consulta->paciente->paterno}} {{$consulta->paciente->materno}}</small>
                                    </div>
                                </div>
                                <div class="project-date">
                                    <span class="hidden-sm-down">{{$consulta->fecha}}</span>
                                </div>
                            </div>
                            <div class="right-col col-lg-6 d-flex align-items-center">
                                <div class="time">
                                    <i class="fa fa-clock-o"></i>{{$consulta->hora->hora}}</div>
                                <div class="comments">
                                    ...
                                    <div class="item clearfix">
                                        ...
                                        <div class="quote has-shadow">
                                            <small>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                                Ipsum has been the industry's standard dummy text ever since the 1500s. Over
                                                the years.</small>
                                        </div>
